...
obj/main.o: src/main.cpp src/SWektorC.cpp src/LZespolona.cpp src/SMacierzC.cpp src/SUkladRownan.cpp
	g++ ${CPPFLAGS} -o obj/main.o src/main.cpp

obj/SUkladRownan.o: src/SUkladRownan.cpp src/SUkladRownanC.cpp inc/SUkladRownan.hh
	g++ ${CPPFLAGS} -o obj/SUkladRownan.o src/SUkladRownan.cpp
